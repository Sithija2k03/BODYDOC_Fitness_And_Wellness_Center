...
import { navItems } from '../utils/navItems'; // Verify path
import { logout } from '../utils/icons'; // Verify path
...
function Navigation({ active, setActive }) {
  ...
  const handleNavClick = (id) => {
    if (id === 6) {
      ...
      setActive(id);
      setInventoryOpen(false); // Close dropdown for other items
    }
  };
